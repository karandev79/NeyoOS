      ...
      <div className="max-w-md w-full space-y-8 border border-white/10 p-10 rounded-[2rem] bg-zinc-950 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center space-y-2 relative z-10">
          <div className="flex justify-center mb-6">
            <div className="p-4 bg-zinc-900 rounded-2xl border border-white/5 flex items-center justify-center">
              <Image src={logo} alt="NeyoOS Logo" width={40} height={40} className="rounded-xl object-contain opacity-90 hover:opacity-100 transition-opacity" />
            </div>
          </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4 relative z-10">
          <div className="space-y-3">
            <input type="text" placeholder="Username" required className="w-full bg-zinc-900 border border-zinc-800 rounded-xl py-4 px-6 text-xs tracking-widest focus:border-blue-500 transition-all placeholder:opacity-20 outline-none"
